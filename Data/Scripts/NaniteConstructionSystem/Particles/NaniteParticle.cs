...
namespace Ntech.Nanite.Particles
{
    public class NaniteParticle
    {
        ...
        public void Update()
        {
            ...
            {
                NaniteConstructionSystem.Logging.Instance.WriteLine(string.Format("Update Exception: {0} - {1} {2}", ex.ToString(), m_paths.Count, GetPathPointCount()));
            }
        }
        ...
        public void Draw()
        {
            ...
            {
                NaniteConstructionSystem.Logging.Instance.WriteLine(string.Format("Draw Exception: {0}", ex.ToString()));
            }
        }
