...
namespace Ntech.Nanite.Particles
{
    public class ParticleEffectManager
    {
        ...
        {
            NaniteConstructionSystem.Logging.Instance.WriteLine(string.Format("ADDING particle effect: grid={0} pos={1} effid={2}", targetGridId, position, effectId));
        ...
        {
            NaniteConstructionSystem.Logging.Instance.WriteLine(string.Format("REMOVING particle effect: {0} {1}", targetGridId, position));
            ...
            NaniteConstructionSystem.Logging.Instance.WriteLine("REMOVE Failed - Running cleanup");
            Cleanup();
        }
        ...
        public void Update()
        {
            ...
            if (!MyAPIGateway.Session.IsServer && m_updateCount % 120 == 0)
                Cleanup();
        } 
    ...
    public class TargetEntity
    {
        ...
        public void UpdateMatrix()
        {
            ...
            m_particle.WorldMatrix = Extensions.EntityHelper.GetBlockWorldMatrix(slimBlock);
        }
    }
}
